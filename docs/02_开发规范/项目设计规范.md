...
> 规范级别：本文件是项目设计与实现的主要依据；产品入口见 docs/03_技术决策/ADR-0001-用户入口设计.md，阶段 2 执行边界见 ADR-0002，阶段 2.1 持久化边界见 ADR-0003，代码组织见 ADR-0004，阶段 2.2 Job/Worker 控制面见 ADR-0005，阶段 2.3 持久请求与隔离进程见 ADR-0006，阶段 2.4 工件发布与恢复见 ADR-0007，仓库信息架构见 ADR-0008，阶段 3 录制见 ADR-0009，阶段 4 控制面与 GUI 见 ADR-0010
