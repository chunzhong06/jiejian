...
- `aiStatusLabel`
- `systemStatusLabel`
主要 import / dot-source：`../api/llm`, `../api/projects`, `../api/system`, `../components/ApplicationSwitcher`, `@ant-design/icons`, `antd`
...
- `ControlShell`
主要 import / dot-source：`../api/experience`, `../api/http`, `../api/projects`, `../api/system`, `../components/ErrorRecovery`, `../components/JudgeGuideBar`, `../components/ProcessNavigation`, `../features/access/AccessPage`, `../features/checks/CheckHistoryPage`, `../features/checks/CheckResultsPage`, `../features/checks/PermissionCheckPage`, `../features/identities/TestIdentityPage`, `../features/recording/RecordingPage`, `../features/settings/LLMSettingsDrawer`, `../features/settings/ModelServicePage`, `../features/system/RuntimePage`, `../features/workspace/WorkbenchPage`, `./AppHeader`, `./NotificationCenter`, `./presentation`, `./useProjectWorkspace`, `./useSystemStatus`, `antd`, `react`, `react-router-dom`
...
### `product/frontend/src/components/AdvancedDetails.tsx`
- `AdvancedDetails`
...
- `ApplicationSetup`
主要 import / dot-source：`../../api/http`, `../../api/onboarding`, `../../api/projects`, `../../components/AdvancedDetails`, `../../components/TaskActionBar`, `antd`, `react`
...
- `CheckHistoryPage`
主要 import / dot-source：`../../api/http`, `../../api/results`, `../../app/presentation`, `../../components/AdvancedDetails`, `../../components/PageTaskHeader`, `../../components/TaskActionBar`, `antd`, `react`
...
- `CheckResultsPage`
主要 import / dot-source：`../../api/http`, `../../api/results`, `../../api/runs`, `../../app/presentation`, `../../components/AdvancedDetails`, `../../components/PageTaskHeader`, `../../components/TaskActionBar`, `./EvidenceTimeline`, `./ReportPanel`, `antd`, `react`
...
- `PermissionCheckPage`
主要 import / dot-source：`../../api/checks`, `../../api/http`, `../../api/permissionIntents`, `../../api/projects`, `../../api/runs`, `../../app/presentation`, `../../components/PageTaskHeader`, `../../components/TaskActionBar`, `../permissions/PermissionAdvancedPanel`, `./CheckProgress`, `antd`, `react`
...
- `TestIdentityPage`
主要 import / dot-source：`../../api/http`, `../../api/projects`, `../../api/testIdentities`, `../../components/AdvancedDetails`, `../../components/PageTaskHeader`, `../../components/TaskActionBar`, `antd`, `react`
...
主要 import / dot-source：`../../../api/contracts`, `../../../api/executionProfiles`, `../../../api/http`, `../../../api/projects`, `../../../app/presentation`, `antd`, `react`
...
主要 import / dot-source：`../../api/recordings`, `../../components/AdvancedDetails`, `antd`, `react`

### `product/frontend/src/features/recording/FlowDraftReview.tsx`
- `FlowDraftReview`
主要 import / dot-source：`../../api/recordings`, `../../components/AdvancedDetails`, `antd`
...
- `RecordingPage`
主要 import / dot-source：`../../api/http`, `../../api/projects`, `../../api/recordings`, `../../api/runs`, `../../app/browserState`, `../../components/AdvancedDetails`, `../../components/PageTaskHeader`, `../../components/TaskActionBar`, `./ActionSafetySetupCard`, `./FlowDraftReview`, `./RecordingCaptureCard`, `./RecordingSetupCard`, `antd`, `react`
...
- `WorkbenchPage`
主要 import / dot-source：`../../api/assistant`, `../../api/experience`, `../../api/projects`, `../../api/runs`, `../../api/system`, `../../app/presentation`, `../../components/PageTaskHeader`, `antd`, `react`
