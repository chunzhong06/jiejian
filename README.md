...
在官方“协作空间”里，Alice 是项目负责人，Bob 是普通成员。人已经确认：Bob 不能生成完整项目资料包。
...
- [竞赛验证主张与证据](docs/02_开发指南/任务/竞赛验证主张与证据.md)
- [竞赛追问账](docs/02_开发指南/任务/竞赛追问账.md)
- [竞赛理解验收脚本](docs/02_开发指南/任务/竞赛理解验收脚本.md)
