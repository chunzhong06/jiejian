...
from product.protocols import ActionExecutionBinding, ExecutionIdentity, ExecutionProjectSnapshot, ObserverRequirementBinding, ObserverSpec, SubjectExecutionBinding, TargetType, WebTargetDefinition
...
class ExecutionProfile(BaseModel):
    ...
    def build_snapshot(
        ...
        *,
        ...
        bindings = self.action_bindings if action_bindings_override is None else action_bindings_override
