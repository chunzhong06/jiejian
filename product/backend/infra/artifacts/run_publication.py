...
#
# 调用链
#   RunnerSupervisor / Reconciliation → RunPublisher → filesystem / StorageUnitOfWork
# =============================================================================
...
from product.protocols import RunnerResultType, RunnerResult, StagedArtifact
...
from product.backend.infra.artifacts.run_packages import PUBLICATION_MANIFEST_NAME, PublicationManifest, StagedAttempt, ValidatedPublication, evidence_records_for_publication, final_run_dir, read_publication_manifest, reject_reparse_parents, validate_published_run, validate_runner_staging, write_publication_manifest
