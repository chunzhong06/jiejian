...
#
# 调用链
#   ContractAnalysis → parse_fastapi_source_candidates → CandidateBatch
# =============================================================================
    ...
    *,
    ...
    for node in ast.walk(tree):
        ...
        for decorator in node.decorator_list:
            ...
            kind = CandidateRiskKind.FOREIGN_READ if method == "GET" else CandidateRiskKind.UNAUTHORIZED_SIDE_EFFECT
