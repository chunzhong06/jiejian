...
export type ProjectRepair = { project_id: string; status: RepairStatus | null; primary_task_reference: string | null; tasks: Array<{ task_reference: string; contract: RepairContract; status: RepairStatus; change_id: string | null; run_id: string | null; verification: RepairVerification | null }> }
