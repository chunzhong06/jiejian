...
export function SourceIdentityPanel({ projectId, recordId, kind, onNavigate, onIntegrityError }: {
  projectId: string; recordId: string; kind: 'runs' | 'source-changes'; onNavigate: (path: string) => void; onIntegrityError?: (error: ApiError) => void
}) {
