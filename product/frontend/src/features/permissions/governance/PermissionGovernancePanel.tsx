...
import { Alert, Button, Card, Checkbox, Descriptions, Divider, Form, Input, List, Select, Space, Typography } from 'antd'
import {
  contractsApi,
...
export function PermissionGovernancePanel({ project, profiles, onError, onChanged }: {
  project: ProjectDto
  profiles: LLMProfile[]
  ...
  const registerProfile = async () => {
    ...
    if (!path) { setProfileMessage({ type: 'warning', text: '请输入当前执行配置（ExecutionProfile）的文件路径。' }); return }
