...
from jiejian.artifacts import load_report
...
from jiejian.services import RunService
...
def test_all_stage1_cli_commands_and_ci_exit_codes(
    ...
    assert json.loads(report_result.stdout)["run_id"] == run_payload["run_id"]
...
def test_cli_uses_separate_input_system_and_safety_exit_codes(
    ...
    monkeypatch.setattr(RunService, "run", fail_run)
