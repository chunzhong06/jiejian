# 验证 Permission Contract 的严格解析、canonical、Schema 和编译边界。
...
def test_batch_rule_requires_batch_action_and_preserves_per_resource_expectations() -> None:
    from product.backend.core.verification.permissions.coverage import BatchAuthorizationMode, build_permission_coverage_plan
