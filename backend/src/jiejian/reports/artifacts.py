...
class ArtifactResultReader:
    ...
    def _parse_request(self, path: Path) -> ArtifactCheckRequestV1:
        try:
            return ArtifactCheckRequestV1.model_validate_json(path.read_bytes(), strict=True)
    ...
    def _read_published(
        ...
        try:
            manifest = ArtifactResultManifestV1.model_validate_json(
            ...
            result = ArtifactScanResultV1.model_validate_json(result_raw, strict=True)
        except (OSError, ValueError):
