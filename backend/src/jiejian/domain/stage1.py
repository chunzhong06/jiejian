...
from .models import CaseVerdict, ContractStatus, DomainModel, RunVerdict
...
class TargetScope(DomainModel):
    ...
    def validate_scope(self) -> TargetScope:
        ...
        if not self.allow_private_network and _is_restricted_address(address):
