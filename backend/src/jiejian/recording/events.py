...
from .sanitization import RecordingSanitizer
from .transport import BoundedRouteTransport
from .ui_capture import install_ui_capture

_SAFETY_EVENT_RESERVE_BYTES = 768


class RecordingEventCollector:
    """连接 Playwright context，并只暴露经过授权和脱敏的 V1 事件。"""
    ...
    def __init__(
        ...
        *,
        ...
        self.events: tuple[RecordingEventV1, ...] = ()
        ...
        self._guards: dict[str, TargetGuard] = {}
    ...
    def attach_context(self, identity_id: str, context: BrowserContext) -> None:
        ...
        self._guards[identity_id] = TargetGuard(self.scope)
        install_ui_capture(
            context,
    ...
    @staticmethod
    def _event_size(event: RecordingEventV1) -> int:
        return len(
            json.dumps(
