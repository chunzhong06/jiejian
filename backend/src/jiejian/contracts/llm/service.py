...
#
# 调用链
#   ContractWorkbench → LLMCandidateGenerationService → LLMProvider / Storage
# =============================================================================
...
from .models import LLMGenerationResult, LLMOutput
from ...errors import ErrorCode, JiejianError
from ...redaction import redact_known_secrets
from ...storage import StorageUnitOfWork
from .profiles import ResolvedLLMProvider
...
_PROMPT_TEMPLATE = (
    "Return only schema_version=1 JSON with candidates containing requirement_ids and rule. "
    "Use only the supplied requirements and existing ContractRule enums.\n"
    "INPUT_JSON:\n"
)
_PROMPT_TEMPLATE_SHA256 = hashlib.sha256(_PROMPT_TEMPLATE.encode("utf-8")).hexdigest()


class LLMCandidateGenerationService:
