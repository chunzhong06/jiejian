...
#
# 调用链
#   ContractAnalysisService → diff_contract_versions → ContractVersionDiff
# =============================================================================
...
from .models import ContractVersionDiff, ProvenanceDelta, RuleDiff
...
def diff_contract_versions(
    ...
    before_rules = {rule.id: rule for rule in before.snapshot.rules}
    after_rules = {rule.id: rule for rule in after.snapshot.rules}
    changed = tuple(
