...
from ...domain.identifiers import CANDIDATE_ID_PATTERN, LONG_SLUG_ID_PATTERN, PROJECT_ID_PATTERN
...
class ContractVersionDiff(AnalysisModel):
    ...
    added: tuple[ContractRule, ...] = Field(default=(), max_length=2048)
    removed: tuple[ContractRule, ...] = Field(default=(), max_length=2048)
